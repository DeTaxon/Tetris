...
tetris:
	./halfvoid -g -extra -C0 ExperimentalLibrary -C0 StandardHVLibrary -C1 Source -o /tmp/tetris.ll -cache /tmp/TetrisCache.zip
...
run_nonstop:
	GALLIUM_HUD=fps+cpu $(gdb_tui) ./halfvoid -run main -nonstop -extra -g  -C0 ExperimentalLibrary -C0 StandardHVLibrary -C1 Source -cache /tmp/TetrisCache.zip 
